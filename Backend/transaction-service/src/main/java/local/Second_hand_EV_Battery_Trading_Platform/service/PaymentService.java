...
public interface PaymentService {
     ...
     * @return đối tượng Payment (bao gồm cả thông tin khách hàng)
     */
    Payment findByTransactionId(String transactionId);

    /**
     * Lấy thông tin chi tiết thanh toán để hiển thị cho frontend (kết hợp dữ liệu từ cart-service).
     * @param transactionId mã giao dịch duy nhất (UUID)
     * @return PaymentInfoResponse (bao gồm customer info, product info, total, v.v.)
     */
