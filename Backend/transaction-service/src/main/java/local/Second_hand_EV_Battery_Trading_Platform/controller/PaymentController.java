...
public class PaymentController {
    ...
    public ResponseEntity<?> getPaymentInfo(@PathVariable String transactionId) {
        ...
        try {
            ...
            result.put("transactionId", info.getTransactionId());
            result.put("status", info.getStatus());
            result.put("method", info.getMethod());
            ...
            result.put("price", info.getPrice());
            result.put("totalAmount", info.getTotalAmount());
